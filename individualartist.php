      ...
      <div class="row">
        ...
        <div class="col-md-8 col-sm-8">
          ...
          <div class="tab-pane fade show active" id="ex1-tabs-1" role="tabpanel" aria-labelledby="ex1-tab-1">
            ...
            ?>
              <div class="inside col-md-4 col-sm-6">
                <a href="individualartwork.php?uid=<?= $options1[$y]['artworkID'];?>"><img src="<?= $options1[$y]['link']; ?>" style="height: 200px; width: 225px"> <br></a>
          ...
          <div class="tab-pane fade" id="ex1-tabs-2" role="tabpanel" aria-labelledby="ex1-tab-2">
            ...
            ?>
              <div class="inside col-md-4 col-sm-6">
                <a href="individualartwork.php?uid=<?= $options1[$z]['artworkID'];?>"><img src="<?= $options1[$z]['link']; ?>" style="height: 200px; width: 225px"> <br></a>
